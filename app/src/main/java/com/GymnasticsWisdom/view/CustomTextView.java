package com.GymnasticsWisdom.view;
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            if(typefaceName != null) {
                Typeface tf = Typeface.createFromAsset(getContext().getAssets(), String.format("carterone.ttf", typefaceName));
                setTypeface(tf);
            }
//
...
//            }
            ...
            if(a.hasValue(R.styleable.CustomTextView_innerShadowColor)){
                this.addInnerShadow(a.getDimensionPixelSize(R.styleable.CustomTextView_innerShadowRadius, 0),
                        a.getDimensionPixelOffset(R.styleable.CustomTextView_innerShadowDx, 0),
                        a.getDimensionPixelOffset(R.styleable.CustomTextView_innerShadowDy, 0),
            ...
            if(a.hasValue(R.styleable.CustomTextView_outerShadowColor)){
                this.addOuterShadow(a.getDimensionPixelSize(R.styleable.CustomTextView_outerShadowRadius, 0),
                        a.getDimensionPixelOffset(R.styleable.CustomTextView_outerShadowDx, 0),
                        a.getDimensionPixelOffset(R.styleable.CustomTextView_outerShadowDy, 0),
