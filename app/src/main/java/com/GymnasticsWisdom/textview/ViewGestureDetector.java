...
package com.GymnasticsWisdom.textview;
...
public class ViewGestureDetector {
    ...
    interface OnScaleGestureListener {
         ...
         *          handled. This can be useful if an application, for templatevilla,
         *          only wants to update scaling factors if the change is
         *          greater than 0.01.
         */
        boolean onScale(View view, ViewGestureDetector detector);
         ...
         *          this gesture. For templatevilla, if a gesture is beginning
         *          with a focal point outside of a region where it makes
         *          sense, onScaleBegin() may return false to ignore the
         *          rest of the gesture.
         */
        boolean onScaleBegin(View view, ViewGestureDetector detector);

        /**
         * Responds to the end of a scale gesture. Reported by existing
         * pointers going up.
         *
         * Once a scale has ended, {@link ViewGestureDetector#getFocusX()}
         * and {@link ViewGestureDetector#getFocusY()} will return the location
         * of the pointer remaining on the screen.
         *
         * @param detector The detector reporting the event - use this to
         *          retrieve extended info about event state.
         */
        void onScaleEnd(View view, ViewGestureDetector detector);
  ...
  public   ViewGestureDetector(OnScaleGestureListener listener) {
        mListener = listener;
        ...
        if (mInvalidGesture) {
            ...
            switch (action) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    mFocusX = view.getX() - event.getRawX();
                    mFocusY = view.getY() - event.getRawY();
...
//                    view.animate()
//                            .x(event.getRawX() + mFocusX)
//                            .y(event.getRawY() + mFocusY)
//                            .setDuration(0)
//                            .start();
